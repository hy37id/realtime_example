defmodule Realtime.Factory do
  ...
  ## Examples
      ...
      Factory.build(:user)
      # => %Realtime.Accounts.User{name: "John Smith"}

      Factory.build(:user, name: "Jane Smith")
      # => %Realtime.Accounts.User{name: "Jane Smith"}
  ...
  You could call `build/2` to customize the name:
      ...
      # => %Realtime.Accounts.User{name: "Custom Name"}
  """
